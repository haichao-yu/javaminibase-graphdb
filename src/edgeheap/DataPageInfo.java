 ...
 */
   ...
   * @param _aedge: the input tuple
   */
  public DataPageInfo(Edge _aedge)
  ...
  {   
    ...
    if (_aedge.getLength()!=12){
      ...
      data = _aedge.returnTupleByteArray();
      offset = _aedge.getOffset();
       ...
       throws IOException
  {
    ...
    // 2) creat a edge object using this array
    Edge aedge = new Edge(data, offset, size);
 
    // 3) return edge object
    return aedge;
