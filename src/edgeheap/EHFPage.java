...
public class EHFPage extends Page
  ...
  */
    ...
    /**
     * inserts a new record onto the page, returns EID of this record
     *
     * @param record a record to be inserted
     * @return EID of record, null if sufficient space does not exist
     * @throws IOException I/O errors
     *                     in C++ Status insertRecord(char *recPtr, int recLen, EID& eid)
     */
    ...
    /**
     * delete the record with the specified eid
     *
     * @param eid the record ID
     * @throws IOException                I/O errors
     *                                    in C++ Status deleteRecord(const EID& eid)
     ...
     * @throws IOException I/O errors
     *                     in C++ Status firstRecord(EID& firstRid)
     */
     ...
     * @throws IOException I/O errors
     *                     in C++ Status nextRecord (EID curRid, EID& nextRid)
     */
    public EID nextRecord(EID curEid)
            throws IOException {
        EID eid = new EID();
        slotCnt = Convert.getShortValue(SLOT_CNT, data);
    ...
    /**
     * copies out record with EID eid into record pointer.
     * <br>
     * Status getRecord(EID eid, char *recPtr, int& recLen)
     *
     * @param eid the record ID
     * @return a edge contains the record
     * @throws InvalidSlotNumberException Invalid slot number
     * @throws IOException                I/O errors
     * @see Edge
     */
    ...
    /**
     * returns a edge in a byte array[pageSize] with given EID eid.
     * <br>
     * in C++	Status returnRecord(EID eid, char*& recPtr, int& recLen)
     *
     * @param eid the record ID
     * @return a edge  with its length and offset in the byte array
     * @throws InvalidSlotNumberException Invalid slot number
     * @throws IOException                I/O errors
     * @see Edge
     */
