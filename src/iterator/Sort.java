...
public class Sort extends Iterator implements GlobalConst {
	...
	*/
    ...
    private int generate_runs(int max_elems, AttrType sortFldType, int sortFldLen)
        ...
        try {
            lastElem.setHdr(n_cols, _in, str_lens); // add Tuple: setHdr: case attrib.Desc: 20
        } catch (Exception e) {
        ...
        while (true) {
            ...
            // Task 2.6 if attribute is attrDesc, then use compareTuple function with distance and target
	...
	*/
    ...
    private void MIN_VAL(Tuple lastElem, AttrType sortFldType)
        ...
        //Task 2.6 set Minvalue of Descriptor
        Descriptor DesMinvalue = new Descriptor();
        DesMinvalue.set(0,0,0,0,0);
    ...
    private void MAX_VAL(Tuple lastElem, AttrType sortFldType)
        ...
        //Task 2.6: set Maxvalue of Descriptor
        Descriptor DesMaxvalue = new Descriptor();
        DesMaxvalue.set(10000,10000,10000,10000,10000);
        ...
        switch (sortFldType.attrType) {
            ...
            case AttrType.attrString:
                ...
                break;
            case AttrType.attrDesc:
                lastElem.setDescFld(_sort_fld,DesMaxvalue);
                break;
            default:
                // don't know how to handle attrSymbol, attrNull
                //System.err.println("error in sort.java");
    ...
    // Task 2.6: use sort with given distance and target
