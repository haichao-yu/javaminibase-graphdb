...
public class NHFPage extends Page
  ...
  */
    ...
    public NHFPage(Page page) {
        data = page.getpage(); // data is extended from class Page
    }
     ...
     *
     * @throws IOException I/O errors
     *                     in C++ Status deleteRecord(const NID& rid)
     * @param    rid the record ID
     * @exception InvalidSlotNumberException Invalid slot number
     */
    public void deleteRecord(NID rid)
            throws IOException,
     ...
     * @throws IOException I/O errors
     *                     in C++ Status firstRecord(NID& firstRid)
     */
     ...
     * @throws IOException I/O errors
     *                     in C++ Status nextRecord (NID curRid, NID& nextRid)
     */
    public NID nextRecord(NID curRid)
            throws IOException {
        NID rid = new NID();
        slotCnt = Convert.getShortValue(SLOT_CNT, data);
    ...
    /**
     * copies out record with NID rid into record pointer.
     * <br>
     * Status getRecord(NID rid, char *recPtr, int& recLen)
     *
     * @return a node contains the record
     * @throws InvalidSlotNumberException Invalid slot number
     * @throws IOException                I/O errors
     * @param    rid the record ID
     * @see Node
     */
    public Node getRecord(NID rid)
            throws IOException,
            InvalidSlotNumberException {
        short recLen;
        short offset;
    ...
    /**
     * returns a node in a byte array[pageSize] with given NID rid.
     * <br>
     * in C++	Status returnRecord(NID rid, char*& recPtr, int& recLen)
     *
     * @param rid the record ID
     * @return a node  with its length and offset in the byte array
     * @throws InvalidSlotNumberException Invalid slot number
     * @throws IOException                I/O errors
     * @see Node
     */
    public Node returnRecord(NID rid)
            throws IOException,
            InvalidSlotNumberException {
        short recLen;
        short offset;
